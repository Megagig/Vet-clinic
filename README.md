...
```bash
  git clone https://github.com/Megagig/vet-clinic.git
```
...
Feel free to check the [issues page](https://github.com/megagig/vet-clinic/issues).
...
This project is [MIT](https://github.com/Megagig/Vet-clinic-/blob/develop/LICENSE) licensed.
